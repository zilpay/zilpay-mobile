...
mod wallet_tests {
    ...
    async fn test_d_add_chain_provider() {
        ...
        let providers: Vec<ChainConfig> = get_chains_providers_from_json(content)
            ...
            .collect();
        let zilliqa_provider_mainnet = providers.get(4).unwrap();
        ...
        assert_eq!(zilliqa_provider_mainnet.explorers.len(), 4);
        ...
        assert_eq!(zilliqa_provider_mainnet.ftokens[0].name, "EVM");
        ...
        let binance_provider_mainnet = &providers[3];
