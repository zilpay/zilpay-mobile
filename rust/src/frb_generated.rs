...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 804180167;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        22 => wire__crate__api__network__get_provider_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__provider__get_provider_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__network__get_providers_impl(port, ptr, rust_vec_len, data_len),
        ...
        31 => wire__crate__api__network__remove_provider_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__wallet__select_account_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__api__network__select_provider_impl(port, ptr, rust_vec_len, data_len),
        ...
        49 => wire__crate__api__token__update_token_list_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
