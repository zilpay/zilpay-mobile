    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            let api_that = <RustOpaqueMoi<
                flutter_rust_bridge::for_generated::RustAutoOpaqueInner<WalletInfo>,
            >>::sse_decode(&mut deserializer);
            let api_tokens = <Vec<FToken>>::sse_decode(&mut deserializer);
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let mut api_that_guard = None;
                let decode_indices_ =
...
impl SseDecode for Vec<FToken> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut len_ = <i32>::sse_decode(deserializer);
        let mut ans_ = vec![];
        for idx_ in 0..len_ {
            ans_.push(<FToken>::sse_decode(deserializer));
        }
        return ans_;
    }
}
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        28 => wire__crate__api__backend__add_ledger_zilliqa_wallet_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        32 => wire__crate__api__backend__get_wallets_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__api__backend__is_service_running_impl(port, ptr, rust_vec_len, data_len),
        ...
        37 => wire__crate__api__backend__sync_balances_impl(port, ptr, rust_vec_len, data_len),
        38 => wire__crate__api__backend__try_unlock_with_password_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        39 => wire__crate__api__backend__try_unlock_with_session_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        40 => wire__crate__api__methods__gen_bip39_words_impl(port, ptr, rust_vec_len, data_len),
        41 => wire__crate__api__methods__gen_keypair_impl(port, ptr, rust_vec_len, data_len),
...
impl SseEncode for Vec<FToken> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(self.len() as _, serializer);
        for item in self {
            <FToken>::sse_encode(item, serializer);
        }
    }
}
