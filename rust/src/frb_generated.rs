...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1937275764;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        55 => wire__crate__api__backend__start_service_impl(port, ptr, rust_vec_len, data_len),
        56 => wire__crate__api__backend__start_worker_impl(port, ptr, rust_vec_len, data_len),
        57 => wire__crate__api__backend__stop_service_impl(port, ptr, rust_vec_len, data_len),
        58 => wire__crate__api__token__sync_balances_impl(port, ptr, rust_vec_len, data_len),
        59 => {
