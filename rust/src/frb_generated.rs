...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        16 => wire__crate__api__stake__build_tx_scilla_complete_withdrawal_avely_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        31 => wire__crate__api__token__fetch_token_meta_impl(port, ptr, rust_vec_len, data_len),
        32 => {
            wire__crate__api__token__fetch_tokens_evm_list_impl(port, ptr, rust_vec_len, data_len)
        }
        33 => wire__crate__api__token__fetch_tokens_list_zilliqa_legacy_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        50 => wire__crate__api__stake__get_stakes_impl(port, ptr, rust_vec_len, data_len),
        ...
        56 => wire__crate__api__methods__is_crypto_address_impl(port, ptr, rust_vec_len, data_len),
