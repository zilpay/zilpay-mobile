...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1947254648;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        21 => wire__crate__api__provider__get_provider_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__api__provider__get_providers_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__token__get_rates_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__transaction__get_requested_transactions_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        25 => wire__crate__api__wallet__get_wallets_impl(port, ptr, rust_vec_len, data_len),
