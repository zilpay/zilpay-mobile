...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 207064960;
...
fn wire__crate__api__backend__tick_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::backend::tick(api_sink)?;
                    Ok(output_ok)
                })())
            }
        },
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        41 => wire__crate__api__connections__remove_connections_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        54 => wire__crate__api__transaction__sign_send_transactions_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        55 => wire__crate__api__backend__start_block_worker_impl(port, ptr, rust_vec_len, data_len),
        56 => wire__crate__api__transaction__start_history_worker_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        57 => wire__crate__api__backend__stop_block_worker_impl(port, ptr, rust_vec_len, data_len),
        58 => wire__crate__api__transaction__stop_history_worker_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        59 => wire__crate__api__backend__stop_service_impl(port, ptr, rust_vec_len, data_len),
        60 => wire__crate__api__token__sync_balances_impl(port, ptr, rust_vec_len, data_len),
        61 => wire__crate__api__backend__tick_impl(port, ptr, rust_vec_len, data_len),
        62 => {
