...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1545151007;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        81 => wire__crate__api__wallet__zilliqa_get_0x_impl(port, ptr, rust_vec_len, data_len),
        82 => wire__crate__api__wallet__zilliqa_get_bech32_base16_address_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        83 => wire__crate__api__wallet__zilliqa_legacy_base16_to_bech32_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
