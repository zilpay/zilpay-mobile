...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1645542559;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        55 => wire__crate__api__transaction__sign_send_transactions_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        56 => wire__crate__api__backend__start_block_worker_impl(port, ptr, rust_vec_len, data_len),
        57 => wire__crate__api__transaction__start_history_worker_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        58 => wire__crate__api__backend__stop_block_worker_impl(port, ptr, rust_vec_len, data_len),
        59 => wire__crate__api__transaction__stop_history_worker_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        60 => wire__crate__api__backend__stop_service_impl(port, ptr, rust_vec_len, data_len),
        61 => wire__crate__api__token__sync_balances_impl(port, ptr, rust_vec_len, data_len),
        62 => {
        ...
        64 => wire__crate__api__token__update_rates_impl(port, ptr, rust_vec_len, data_len),
        65 => wire__crate__api__wallet__zilliqa_get_bech32_base16_address_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        66 => wire__crate__api__wallet__zilliqa_legacy_base16_to_bech32_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        67 => wire__crate__api__wallet__zilliqa_swap_chain_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
