...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -59375881;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        15 => wire__crate__api__transaction__clear_requested_transactions_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        16 => wire__crate__api__connections__create_new_connection_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        17 => wire__crate__api__wallet__delete_wallet_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__token__fetch_token_meta_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__methods__gen_bip39_words_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__api__methods__gen_keypair_impl(port, ptr, rust_vec_len, data_len),
        21 => wire__crate__api__qrcode__gen_png_qrcode_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__api__qrcode__gen_svg_qrcode_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__book__get_address_book_list_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__connections__get_connections_list_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        25 => wire__crate__api__backend__get_data_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__transaction__get_history_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__cache__get_image_bytes_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__api__cache__get_image_name_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__provider__get_provider_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__provider__get_providers_impl(port, ptr, rust_vec_len, data_len),
        31 => wire__crate__api__token__get_rates_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__transaction__get_requested_transactions_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        33 => wire__crate__api__wallet__get_wallets_impl(port, ptr, rust_vec_len, data_len),
        34 => wire__crate__api__methods__init_app_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__api__methods__is_crypto_address_impl(port, ptr, rust_vec_len, data_len),
        36 => wire__crate__api__backend__is_service_running_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api__methods__keypair_from_sk_impl(port, ptr, rust_vec_len, data_len),
        38 => wire__crate__api__qrcode__parse_qrcode_str_impl(port, ptr, rust_vec_len, data_len),
        39 => wire__crate__api__wallet__reveal_bip39_phrase_impl(port, ptr, rust_vec_len, data_len),
        40 => wire__crate__api__wallet__reveal_keypair_impl(port, ptr, rust_vec_len, data_len),
        41 => wire__crate__api__token__rm_ftoken_impl(port, ptr, rust_vec_len, data_len),
        42 => wire__crate__api__wallet__select_account_impl(port, ptr, rust_vec_len, data_len),
        43 => wire__crate__api__settings__set_global_notifications_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        44 => wire__crate__api__settings__set_rate_fetcher_impl(port, ptr, rust_vec_len, data_len),
        45 => wire__crate__api__settings__set_theme_impl(port, ptr, rust_vec_len, data_len),
        46 => wire__crate__api__settings__set_wallet_ens_impl(port, ptr, rust_vec_len, data_len),
        47 => wire__crate__api__settings__set_wallet_gas_control_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        49 => wire__crate__api__settings__set_wallet_node_ranking_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        50 => wire__crate__api__settings__set_wallet_notifications_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        51 => wire__crate__api__backend__start_service_impl(port, ptr, rust_vec_len, data_len),
        52 => wire__crate__api__backend__start_worker_impl(port, ptr, rust_vec_len, data_len),
        53 => wire__crate__api__backend__stop_service_impl(port, ptr, rust_vec_len, data_len),
        54 => wire__crate__api__token__sync_balances_impl(port, ptr, rust_vec_len, data_len),
        55 => {
        ...
        57 => wire__crate__api__token__update_rates_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
