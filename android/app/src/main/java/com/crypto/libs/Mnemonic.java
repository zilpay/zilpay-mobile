...
/**
 * Created by skylab on 7/21/18.
 */

public class Mnemonic {

    private final String salt = "zilpay";
    private byte[] ent;
    ...
    public byte[] GetSeed(String passphrase) {
        try {
            ...
            byte[] saltBytes = (salt + passphrase).getBytes("UTF-8");
    ...
    private final String[] words = new String[] { "abandon", "ability", "able", "about", "above", "absent", "absorb",
