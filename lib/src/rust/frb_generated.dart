...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1481215367;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<TransactionRequestInfo>
      crateApiStakeBuildTxScillaCompleteWithdrawalAvely(
          {required BigInt walletIndex, required BigInt accountIndex});
  ...
  Future<List<FinalOutputInfo>> crateApiStakeGetStakes(
      {required BigInt walletIndex, required BigInt accountIndex});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<TransactionRequestInfo>
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiStakeBuildTxScillaCompleteWithdrawalAvelyConstMeta,
      argValues: [walletIndex, accountIndex],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiStakeBuildTxScillaCompleteWithdrawalAvelyConstMeta =>
          const TaskConstMeta(
            debugName: "build_tx_scilla_complete_withdrawal_avely",
            argNames: ["walletIndex", "accountIndex"],
          );
  ...
  Future<List<FinalOutputInfo>> crateApiStakeGetStakes(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiStakeGetStakesConstMeta,
      argValues: [walletIndex, accountIndex],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStakeGetStakesConstMeta => const TaskConstMeta(
        debugName: "get_stakes",
        argNames: ["walletIndex", "accountIndex"],
      );
